...
class EntryForm(forms.Form):
    ...
    def seriouslyValidate(self,cleaned_data):
        ...
        reaction1ok, scriptout, stuff1=check.checkReaction(cleaned_data.get('reaction'), cleaned_data.get('test1'))
        ...
        if stuff1 is not None and stuff1 != {}:
            ...
            print self.t1
        reaction2ok, scriptout2, stuff2=check.checkReaction(cleaned_data.get('reaction'), cleaned_data.get('test2'))
        ...
        if stuff2 is not None and stuff2 != {}:
            ...
            print self.t2
        reaction3ok, scriptout3, stuff3=check.checkReaction(cleaned_data.get('reaction'), cleaned_data.get('test3'))
